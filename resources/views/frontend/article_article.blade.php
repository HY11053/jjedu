                        ...
                        <div id="article_brandinfo">
                            <table cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="td_style first_line"><strong><a href="/brand/{{$thisBrandArticle->id}}/">{{$thisBrandArticle->brandname}}加盟</a></strong></td>
                            ...
                            <div id="article_brandinfo">
                                <table cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td_style first_line"><strong><a href="/news/{{$thisarticleinfos->id}}/">{{$thisarticleinfos->brandname}}加盟</a></strong></td>
                                        <td class="td_color first_line">投资金额</td>
