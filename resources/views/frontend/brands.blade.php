                ...
                <ul class="xm-list-H224 clearfix" style="width: 870px; float:left; cursor: pointer">
                    @foreach($pagelists as $pagelist)
                        <li class="">
                            ...
                            <div class="f20">
                                <a target="_blank" href="/jyproject/{{$pagelist->id}}.shtml">{{$pagelist->brandname}}加盟</a>
                            </div>
                            <div class="info">
            ...
            <div class="w320 fr">
                ...
                <div class="bg-ff p20">
                    ...
                    <ul class="join-project mt30">
                        ...
                        <li>
                            <a target="_blank" href="/jyproject/{{$flashlingshibrand->id}}.shtml" class="img-block magnify"><img src="{{$flashlingshibrand->litpic}}" alt="{{$flashlingshibrand->brandname}}"></a>
                            <p class="f16"><a target="_blank" href="/jyproject/{{$flashlingshibrand->id}}/">{{$flashlingshibrand->brandname}}</a></p>
